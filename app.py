...
def handle_userinput(user_question):
    ...
    response = st.session_state.conversation({'text': user_question})
...
def main():
    load_dotenv()
    st.set_page_config(page_title="Talk with JAFFA",
                       page_icon="icon.png")
    ...
    if st.button("Process"):
        if not user_text.strip():
            ...
            with st.spinner("Processing"):
                ...
                st.success("Your text has been processed successfully")

                # Automatically use "Summarize the text" as the default question
